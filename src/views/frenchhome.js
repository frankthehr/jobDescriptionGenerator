...
const FrenchHome = () => {
  ...
  const sendPrompt = async (event) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:5000/jobdescriptionfr", request);
  ...
  return (
    <div className={styles.home}>
      <div className={styles.form}>
        <h1>Description de l'emploi Générateur</h1>
        <h5>Écrivez ci-dessous le titre du poste dont vous avez besoin et appuyez sur la touche Entrée.</h5>
        <input
          type="text"
        ...
        { loading &&
          <div className={styles.loading}>
            <span>Votre description de poste est en cours de création</span>
